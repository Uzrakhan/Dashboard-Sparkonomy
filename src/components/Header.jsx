...
const Header = () => {
  return (
    <div className='bg-purple-300 flex justify-between items-center h-full rounded-2xl w-full p-4 lg:p-6'>
        <button>
            <ArrowLeft />
        </button>
        ...
        <div>
            <img 
                ...
                className='w-8 h-8 inline-block rounded-full object-cover lg:w-10 lg:h-10'
